...
const Route_1 = require("../base/decorator/Route");
class ProductController extends BaseController_1.BaseController {
    constructor() {
        super();
        this.path = "/heroes";
        this.addHero = (request, response) => __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    (0, Route_1.Get)("/heros")
], ProductController.prototype, "getAllHero", null);
